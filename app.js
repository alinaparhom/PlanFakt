(function(){
  ...
  document.querySelectorAll('#navigation a').forEach(function(link){link.addEventListener('click',function(){var page=link.dataset.page;document.querySelectorAll('#navigation a').forEach(function(x){x.classList.remove('active')});link.classList.add('active');if(page==='dashboard'){document.getElementById('dashboard').classList.add('active-page');document.getElementById('genericPage').classList.remove('active-page');document.getElementById('pageTitle').textContent='Добрый день, Андрей!'}else{document.getElementById('dashboard').classList.remove('active-page');document.getElementById('genericPage').classList.add('active-page');document.getElementById('genericTitle').textContent=titles[page];document.getElementById('pageTitle').textContent=titles[page]}sidebar.classList.remove('open')})});
